  ...
  return (
    <div className="prose-sm md:prose mx-auto shadow-lg rounded-lg bg-white bg-opacity-25 px-5 pt-5">
      ...
      <p className="indent-4">
        ...
        build a strong foundation of technological skills from low/high voltage
        electronics, pneumatics, hydraulics, and finally computer programming.
      ...
      <p className="indent-4">
        ...
        up when a simple push to the master branch triggers a full-scale
        deployment. I was fortunate to be given access to AWS in its formative
