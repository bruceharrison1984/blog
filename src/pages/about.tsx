...
const About = ({ certifications }: { certifications: CredlyCertificate[] }) => {
  return (
    <>
      <Head>
        <title>about | bruce lee harrison</title>
      </Head>
      <div className="space-y-6">
        <div className="prose-sm md:prose mx-auto shadow-lg rounded-lg bg-white bg-opacity-25 px-5 pt-5">
          ...
          <p className="indent-4">
            ...
            These interests have taking me down a wide variety industries,
            helping me build a strong foundation of technological skills from
            low/high voltage electronics, pneumatics, hydraulics, and finally
            computer programming. The aggregate result of this experience helps
            give me a unique approach to problem solving.
          </p>
          <p className="indent-4">
